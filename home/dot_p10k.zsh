# Generated by Powerlevel10k configuration wizard on 2025-08-07 at 04:18 +05.
...
# Appended for VS Code: let p10k emit shell-integration escape sequences (command
# decorations, sticky scroll, terminal suggest) instead of suppressing them.
